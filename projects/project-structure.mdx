...
Projects ship with comprehensive test suites to validate functionality:
...
├── src/
│   └── __tests__/
│       ├── character.test.ts           # Character configuration
│       ├── character-plugin-ordering.test.ts  # Plugin loading
│       └── e2e/
│           └── project-starter.e2e.ts  # Runtime integration
```

### Test Types

| Test Type | Purpose | What's Validated |
|-----------|---------|-----------------|
| **Component** | Unit tests | Character config, plugin loading, isolated logic |
| **E2E** | Integration | Runtime behavior, memory, message processing |
...
elizaos test --name "character"
```

### Default Test Coverage

ElizaOS projects include these tests out of the box:
...
**E2E Tests:**
- Agent initialization and runtime setup
- Message processing and response generation
- Memory storage and retrieval
- Service registration and plugin integration

For custom test development, see the [Test Your Project](/guides/test-your-project) guide.
