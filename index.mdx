...
Connect with the elizaOS community and get support:

- **[Discord](https://discord.com/invite/ai16z)** - Join the community for real-time help
- **[GitHub Issues](https://github.com/elizaOS/eliza/issues)** - Central repository for bug reporting and feature requests
- **[Telegram Dev Support](https://t.me/+R1qXR1r9vI8zYWZh)** - Get technical support from elizaOS devs
- **[Documentation Feedback](https://github.com/elizaOS/docs/issues)** - Help us improve these docs
