...
<CardGroup cols={2}>
  ...
  <Card title="Bun" icon={BunIcon} href="https://bun.sh/">
    Install the latest Bun runtime
  </Card>
</CardGroup>
...
<Note>
  ...
  **Option 2:** Install natively on Windows, but first install [Git Bash](https://git-scm.com/downloads) and use it as your terminal for running Node.js, Bun, and elizaOS CLI installation and use
</Note>
...
Ready to create your first elizaOS agent? Continue to the [Quickstart](/quickstart) guide to build and run your first project.
