...
const agent = new AgentRuntime({
  ...
  plugins: [
    bootstrapPlugin, // Essential for message handling
    sqlitePlugin, // For memory storage
  ],
});
...
const customAgent = new AgentRuntime({
  character: {
    ...
    bio: 'Expert in software development and troubleshooting',
...
# Task: Generate a technical support response as {{agentName}}
{{providers}}
...
- Off-topic discussion
  ...
  plugins: [bootstrapPlugin, sqlitePlugin],
});
```
