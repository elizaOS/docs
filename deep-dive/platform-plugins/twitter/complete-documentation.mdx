...
description: "The `@elizaos/plugin-twitter` package provides comprehensive Twitter/X API v2 integration for ElizaOS agents. It enables agents to operate as fully autonomou..."
---

# @elizaos/plugin-twitter - Complete Developer Documentation
