...
For detailed information about project and plugin structure, see the [Quickstart Guide](/quickstart.mdx).
...
For a complete guide to getting started with elizaOS, see the [Quickstart Guide](/quickstart.mdx).
...
<CardGroup cols={2}>
  <Card title="Quickstart Guide" icon="rocket" href="/quickstart.mdx">
