...
| [`start`](/cli-reference/start) | Start the ElizaOS agent with configurable plugins and services |
| [`update`](/cli-reference/update) | Update ElizaOS CLI and project dependencies |
| [`test`](/cli-reference/test) | Run tests for ElizaOS agent projects and plugins |
