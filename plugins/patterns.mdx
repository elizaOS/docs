---
title: "Patterns"
description: "Action chaining, callbacks, composition, and advanced implementation patterns"
---
...
For the complete interface definition, see the [ActionResult Interface in the Reference](/plugins/reference#action-interface).
...
<CardGroup cols={2}>
  ...
  <Card title="Plugin Schemas" icon="schema" href="/plugins/schemas">
