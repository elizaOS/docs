...
description: "The `@elizaos/plugin-telegram` package provides comprehensive Telegram Bot API integration for ElizaOS agents. It enables agents to operate as Telegram bots ..."
---

# @elizaos/plugin-telegram - Complete Developer Documentation
