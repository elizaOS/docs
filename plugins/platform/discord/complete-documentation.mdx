...
description: "The `@elizaos/plugin-discord` package provides comprehensive Discord integration for ElizaOS agents. It enables agents to operate as fully-featured Discord b..."
---

# @elizaos/plugin-discord - Complete Developer Documentation
