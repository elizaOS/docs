...
```
You: Process this article: https://example.com/ai-agents
Agent: I'll fetch and process that article... Successfully added to knowledge base!

You: What does the article say about agent architectures?
Agent: According to the article, agent architectures typically consist of...
```
...
<CardGroup cols={2}>
  ...
  <Card title="Advanced Guide" icon="rocket" href="/plugins/knowledge/advanced-configuration">
