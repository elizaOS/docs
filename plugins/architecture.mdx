---
title: "Architecture"
description: "Core plugin system architecture and lifecycle in elizaOS"
---
...
For the complete TypeScript interface definition, see the [Plugin Interface in the Reference](/plugins/reference#plugin-interface).
...
<CardGroup cols={2}>
  <Card title="Plugin Components" icon="blocks" href="/plugins/components">
