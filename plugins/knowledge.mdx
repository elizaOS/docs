...
<CardGroup cols={2}>
  ...
  <Card title="Configuration" icon="cog" href="/plugins/knowledge/basic-configuration">
...
<Tabs>
  ...
  <Tab title="pnpm">
    ```bash
    pnpm add @elizaos/plugin-knowledge
    ```
  </Tab>
  <Tab title="yarn">
    ```bash
    yarn add @elizaos/plugin-knowledge
    ```
  </Tab>
</Tabs>
...
<CardGroup cols={2}>
  ...
  <Card title="Testing Guide" icon="vial" href="/plugins/knowledge/testing-guide">
