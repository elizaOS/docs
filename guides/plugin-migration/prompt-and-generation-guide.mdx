---
title: "ElizaOS Prompt Composition & Generation Guide - v1.x"
description: "> **Important**: This guide provides comprehensive documentation for migrating from `composeContext` to the new prompt composition methods, and from the old ..."
---
