---
title: "ElizaOS Plugin Testing Guide"
description: "This guide provides comprehensive instructions for writing tests for ElizaOS plugins using Bun's built-in test runner"
---
