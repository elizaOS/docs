---
title: "Plugin Migration from 0.x to 1.x"
...
### 2. [State and Providers Guide](./state-and-providers-guide.mdx)
...
### 3. [Prompt and Generation Guide](./prompt-and-generation-guide.mdx)
...
### 4. [Advanced Migration Guide](./advanced-migration-guide.mdx)
...
### 5. [Completion Requirements](./completion-requirements.mdx)
...
### 6. [Testing Guide](./testing-guide.mdx)
...
1. Check the [troubleshooting section](./migration-guide.md#troubleshooting) in the migration guide
2. Search existing [GitHub issues](https://github.com/elizaos/eliza/issues)
3. Join our [Discord community](https://discord.gg/elizaos) for real-time help
