...
<CardGroup cols={2}>
  <Card title="Add Multiple Agents" icon="users" href="/projects/multi-agent">
    Run multiple specialized agents that work together in coordinated workflows
  </Card>
  <Card title="Test an Agent" icon="flask" href="/testing/agent-testing">
    Learn how to write comprehensive tests for your agent's behavior and responses
  </Card>
  <Card title="Deploy a Project" icon="rocket" href="/runtime/deployment">
    Ready to go live? Deploy your elizaOS agent to production environments
  </Card>
  <Card title="Create a Plugin" icon="code" href="/development/plugin-development">
