...
<Note>
This guide assumes you have an elizaOS project set up. If you don't, follow the [quickstart guide](/quickstart.mdx)
</Note>
...
For the complete Character interface, see the [Character Interface documentation](/agents/character-interface). 
