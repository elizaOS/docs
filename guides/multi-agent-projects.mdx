...
<Note>
This guide builds on concepts from [Customize Your Agent](/guides/customize-your-agent)
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Deploy Your Project" icon="rocket" href="/guides/deploy-your-agent">
