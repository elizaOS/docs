...
<Note>
This guide builds on concepts from [Add Multiple Agents](/guides/multi-agent-projects)
</Note>
...
<Note>
ElizaOS projects ship with comprehensive built-in tests for core functionality (character config, plugin loading, runtime behavior). For details on the default test structure, see [Testing Projects](/projects/project-structure#testing-projects).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Publish Your Plugin" icon="upload" href="/guides/plugin-publishing-guide">
