...
<CardGroup cols={2}>
  ...
  <Card title="Deploy Your Project" icon="rocket" href="/guides/deploy-your-project">
    Share your Shakespeare vs Hemingway debates with the world
  </Card>
  <Card title="Plugin Development" icon="wand-magic-sparkles" href="/guides/create-a-plugin">
    Build custom plugins to extend your agents' capabilities
  </Card>
  <Card title="Plugin Publishing" icon="upload" href="/guides/publish-a-plugin">
