...
description: 'Deploy your elizaOS project to production with managed or self-hosted options'
---
...
|---|--------|-------------|-----------|-----:|
|⭐ | **Managed Cloud** | Push to GitHub → Auto deploy | [Railway](https://railway.app), [Render](https://render.com) | ~$20/mo |
|⭐⭐ | **Self-Hosted** | Docker → Your VPS | [Phala](https://phala.network), [Hetzner](https://www.hetzner.com/cloud), [Coolify](https://coolify.io), [DO](https://www.digitalocean.com) | ~$10/mo |
...
<CardGroup cols={2}>
  <Card title="Create Custom Plugins" icon="puzzle-piece" href="/guides/create-and-publish-plugins">
  ...
  <Card title="Monitoring" icon="chart-line" href="/runtime/monitoring">
    Monitor your agent's performance in production
  </Card>
  <Card title="Advanced Configuration" icon="cog" href="/runtime/configuration">
