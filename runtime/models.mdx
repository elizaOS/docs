...
<CardGroup cols={2}>
  <Card title="Services" icon="server" href="/runtime/services">
    Build services that provide model capabilities
  </Card>
  
  <Card title="Providers" icon="database" href="/runtime/providers">
    Supply context to models through providers
  </Card>
  
  <Card title="Runtime Core" icon="cpu" href="/runtime/core">
    Understand model management in the runtime
  </Card>
  
  <Card title="Events" icon="bolt" href="/runtime/events">
    Handle model usage events and metrics
  </Card>
</CardGroup>
