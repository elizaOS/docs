...
<CardGroup cols={2}>
  <Card title="Runtime Core" icon="cpu" href="/runtime/core">
    Understand the core runtime architecture
  </Card>
  
  <Card title="Memory & State" icon="brain" href="/runtime/memory">
    Deep dive into memory management and state persistence
  </Card>
  
  <Card title="Services" icon="server" href="/runtime/services">
    Build services that use providers for context
  </Card>
  
  <Card title="Models" icon="robot" href="/runtime/models">
    Learn how models use provider context for decisions
  </Card>
</CardGroup>
