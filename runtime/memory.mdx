---
title: "Memory & State"
description: "Memory system, state management, and data persistence"
---
...
<CardGroup cols={2}>
  <Card title="Providers" icon="database" href="/runtime/providers">
    Learn how providers use memory to build context
  </Card>
  
  <Card title="Runtime Core" icon="cpu" href="/runtime/core">
    Understand how the runtime manages memory
  </Card>
  ...
  <Card title="Sessions" icon="comments" href="/runtime/sessions">
    See how sessions maintain conversation memory
  </Card>
</CardGroup>
