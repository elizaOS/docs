---
title: "Services"
description: "Background services, integrations, and long-running processes"
---
...
<CardGroup cols={2}>
  <Card title="Runtime Core" icon="cpu" href="/runtime/core">
    Learn how services integrate with the runtime
  </Card>
  
  <Card title="Events" icon="bolt" href="/runtime/events">
    Handle service events and lifecycle hooks
  </Card>
  
  <Card title="Providers" icon="database" href="/runtime/providers">
    Use providers to supply service data
  </Card>
