---
title: "Core"
description: "Core runtime system, lifecycle, and architecture"
---

## System Architecture

The elizaOS runtime follows a modular, plugin-based architecture that orchestrates all agent functionality:
